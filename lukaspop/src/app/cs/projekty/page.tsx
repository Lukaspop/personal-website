...
export const metadata = {
  title: "Projekty",
  description:
    "Zde jsou vypsané mé dokončené projekty, které jsou k dispozici online. Časem zde bude více a více projektů, jasně ukazující, jak se má práce zlepšila.",
  alternates: {
        ...
        <section className="mx-auto max-w-7xl pt-24 pb-16">
          <div className="max-w-2xl space-y-6">
            ...
            <p className="text-lg text-neutral-400">
              Toto jsou mé publikované a dokončené projekty, seřazené od nejnovějších. Ukazují
              hlavně to, jak se moje práce v průběhu času posunula.
            </p>
          </div>
        </section>
